...
@expense_group_routes.route('/<int:id>', methods=["GET"])
@login_required
...
@expense_group_routes.route('/<int:id>', methods=["PUT"])
@login_required
...
@expense_group_routes.route('/<int:id>', methods=["DELETE"])
@login_required
...
def get_all_expenses():
    all_expenses = Expense.query.join(ExpenseGroupUser, Expense.group_id == ExpenseGroupUser.group_id).join(ExpenseGroup, ExpenseGroup.id == ExpenseGroupUser.group_id).filter(ExpenseGroupUser.user_id == current_user.id, ExpenseGroup.name != "NULL").all()
    expense_list = []
